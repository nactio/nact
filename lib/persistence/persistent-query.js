...
class PersistentQuery {
  constructor (system, f, key, snapshotKey, persistenceEngine, { snapshotEvery, cacheDuration, snapshotEncoder = id, snapshotDecoder = id, encoder = id, decoder = id } = {}) {
    if (!key) {
...
const persistentQuery = (parent, f, key, name, properties) =>
    new PersistentQuery(name, parent.system, f, key, parent.system.persistenceEngine, properties).proxy;
